      ...
      <VStack spacing={4} w="full" maxW="1200px">
        ...
        <HStack spacing={4}>
          <Button
            ...
            colorScheme={sortCriteria === "age" ? "blue" : "gray"}
          >
            Sort by Age
          </Button>
          <Button
            onClick={() => sortUsers("student")}
            colorScheme={sortCriteria === "student" ? "blue" : "gray"}
          >
            Sort by Student Status
          </Button>
          <Button
            onClick={() => sortUsers("interests")}
            colorScheme={sortCriteria === "interests" ? "blue" : "gray"}
          >
            Sort by Interests
          </Button>
          <Button
            onClick={() => sortUsers("location")}
            colorScheme={sortCriteria === "location" ? "blue" : "gray"}
          >
            Sort by Location
          </Button>
        </HStack>
